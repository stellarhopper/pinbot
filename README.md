...
| `/audit show [limit]` | admin | Who did what: voids, purges, config and tournament changes. Entries about a score link straight to its photo. Long logs page across messages. |
...
402 tests, no Discord connection needed, under a second. Two tiers:
